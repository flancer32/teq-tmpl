...
This project uses the one-repository topology.

`./ctx/` is versioned together with the software product in the `git@github.com:flancer32/teq-tmpl.git` repository.
